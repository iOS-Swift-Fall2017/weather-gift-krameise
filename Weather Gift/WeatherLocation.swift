        ...
        Alamofire.request(weatherURL).responseJSON(){ response in
            ...
            case .success(let value):
                ...
                for hour in 1...hours {
                    ...
                    let hourlyTempterature = json["hourly"]["data"][hour]["temperature"].doubleValue
                    ...
                    let newHourlyForecast = HourlyForecast(hourlyTime: hourlyTime, hourlyTemperature: hourlyTempterature, hourlyPrecipProb: hourlyPrecipProb, hourlyIcon: hourlyIcon)
